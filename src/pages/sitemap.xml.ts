...
const STATIC_PAGES = [
  ...
  { url: '/eventi/', priority: 0.8, changefreq: 'monthly' },
  { url: '/eventi/compleanni/', priority: 0.7, changefreq: 'monthly' },
  { url: '/eventi/battesimi-comunioni-cresime/', priority: 0.7, changefreq: 'monthly' },
  { url: '/eventi/lauree/', priority: 0.7, changefreq: 'monthly' },
  { url: '/eventi/anniversari/', priority: 0.7, changefreq: 'monthly' },
  { url: '/eventi/meeting-cene-aziendali/', priority: 0.7, changefreq: 'monthly' },
